var createFFmpegCore = (function () {
  ...
  return function (createFFmpegCore) {
    ...
    if (n) (Ca = f.wasmMemory), (qa = f.buffer)
      ...
      ((Ca = new WebAssembly.Memory({ initial: Va / 65536, maximum: Va / 65536, shared: !0 })),
    ...
    function vb(a, b) {
      ...
      var c = Atomics.load(D, L.Vf >> 2),
        d = 0
      if (c == a && Atomics.compareExchange(D, L.Vf >> 2, c, 0) == c && (--b, (d = 1), 0 >= b))
        return 1
    ...
    var L = {
      ...
      vi: function (a, b) {
        a.onmessage = function (c) {
          ...
          else if ('exit' === e) a.yf && Atomics.load(E, (a.yf.Lh + 68) >> 2) && L.Ag(a)
    ...
    var Zb = {
        ...
        createNode: function (a, b, c, d) {
          ...
          O.Df ||
            (O.Df = {
              ...
              link: { node: { Af: O.cf.Af, nf: O.cf.nf, readlink: O.cf.readlink }, stream: {} },
          ...
          N.kf(c.mode)
            ...
            : N.isFile(c.mode)
            ? ((c.cf = O.Df.file.node), (c.df = O.Df.file.stream), (c.gf = 0), (c.bf = null))
            : N.Mf(c.mode)
      ...
      N = {
        ...
        If: function (a) {
          for (var b; ; ) {
            if (N.wg(a))
              return (a = a.jf.Eh), b ? ('/' !== a[a.length - 1] ? a + '/' + b : a + b) : a
            b = b ? a.name + '/' + b : a.name
            a = a.parent
          }
        },
        ...
        chmod: function (a, b, c) {
          ...
          d.cf.nf(d, { mode: (b & 4095) | (d.mode & -4096), timestamp: Date.now() })
        },
        lchmod: function (a, b) {
          N.chmod(a, b, !0)
        },
        ...
        open: function (a, b, c, d, e) {
          ...
          !f.logReadFiles ||
            b & 1 ||
            (N.$g || (N.$g = {}),
            a in N.$g || ((N.$g[a] = 1), h('FS.trackingDelegate error on read file: ' + a)))
          try {
            N.mf.onOpenFile &&
              ((e = 0),
        ...
        writeFile: function (a, b, c) {
          ...
          } else if (ArrayBuffer.isView(b)) N.write(a, b, 0, b.byteLength, void 0, c.Zh)
      ...
      try {
        ...
        for (
          var g = b ? D[b >> 2] : 0,
            ...
            fb = (b ? D[(b + 4) >> 2] : 0) | (c ? D[(c + 4) >> 2] : 0) | (d ? D[(d + 4) >> 2] : 0),
            K = 0;
          K < a;
          K++
        ) {
    ...
    var Q = {
      ...
      createSocket: function (a, b, c) {
        ...
        c.bg = a
        b = N.nh({ path: b, node: c, flags: N.Dh('r+'), seekable: !1, df: Q.df })
        a.stream = b
        return a
      },
      mi: function (a) {
      ...
      qf: {
        ...
        ni: function (a, b) {
          ...
          function d(g) {
            ...
            114 === g[6] &&
            116 === g[7]
              ? ((g = (g[8] << 8) | g[9]), Q.qf.Hh(a, b), (b.port = g), Q.qf.jh(a, b))
    ...
    function Nc(a) {
      ...
      for (c = 0; 8 > c; c++)
        1 < d && 0 === a[c] && c >= g && c < g + d
          ? c === g && ((b += ':'), 0 === g && (b += ':'))
          : ((b += Number(Oc(a[c] & 65535)).toString(16)), (b += 7 > c ? ':' : ''))
      return b
    }
    function Pc(a, b) {
      var c = Sa[a >> 1],
      ...
      try {
        ...
        switch (a) {
          ...
          case 17:
            ...
            for (W = 0; 0 < dc && W < na; W++)
              if (((bc = D[(ha + 8 * W) >> 2]), (cc = D[(ha + (8 * W + 4)) >> 2])))
                (B = Math.min(cc, dc)),
    ...
    function wd(a, b, c, d) {
      if (c)
        if (((a = U.getUniform(R[a], S[b])), 'number' == typeof a || 'boolean' == typeof a))
          switch (d) {
            case 0:
              D[c >> 2] = a
              break
    ...
    function yd(a, b, c, d, e) {
      ...
      return a.subarray(
        ...
        (e +
          d *
            ((c * ({ 5: 3, 6: 4, 8: 2, 29502: 3, 29504: 4 }[b - 6402] || 1) * (1 << g) + k - 1) &
              -k)) >>
          g
      )
    }
    ...
    function Db(a) {
      ...
      var e = a.Rf + a.cg
      d = L.Ef[a.$f] = { worker: b, Rf: a.Rf, cg: a.cg, Kg: a.Kg, Lh: a.$f, threadInfoStruct: a.$f }
    ...
    function Yd(a, b) {
      ...
      if (Atomics.load(E, (a + 68) >> 2))
        return h('Attempted to join thread ' + a + ', which was already detached!'), 28
      for (Vc(); ; ) {
    ...
    var Ge = {
          ...
          if (a >= $c) T(1281)
            ...
            if (d)
              if (35716 == b)
                ...
                if (-1 == d.kg)
                  for (a = R[a], e = U.getProgramParameter(a, 35382), b = d.kg = 0; b < e; ++b)
      ...
      rc: function (a, b, c) {
        c
          ? 35716 == b
            ...
            : 35720 == b
            ? ((a = U.getShaderSource(ed[a])), (D[c >> 2] = a ? a.length + 1 : 0))
      ...
      Ab: function (a, b, c) {
        if (288 >= b) for (var d = zd[b - 1], e = 0; e < b; ++e) d[e] = F[(c + 4 * e) >> 2]
      ...
      yb: function (a, b, c) {
        if (288 >= b) for (var d = Ad[b - 1], e = 0; e < b; ++e) d[e] = D[(c + 4 * e) >> 2]
      ...
      T: function (a) {
        ...
        0 > c
          ...
          : 0 < c != (m == d) &&
            ((g = Math.max(k, g)), b.setTime(b.getTime() + 6e4 * ((0 < c ? m : g) - d)))
        D[(a + 24) >> 2] = b.getDay()
            ...
            return 0 > k(z, p)
              ? g(
                  Math.ceil(
                    (31 -
                      z.getDate() +
                      ($d(Zd(p.getFullYear()) ? ae : be, p.getMonth() - 1) - 31) +
                      p.getDate()) /
                      7
                  ),
                  2
    ...
    var Ab = (f.___pthread_tsd_run_dtors = function () {
      ...
      Cb = (f._emscripten_main_thread_process_queued_calls = function () {
        return (Cb = f._emscripten_main_thread_process_queued_calls = f.asm.ne).apply(
          null,
          arguments
        )
      })
    ...
    var yb = (f._emscripten_register_main_browser_thread_id = function () {
        return (yb = f._emscripten_register_main_browser_thread_id = f.asm.pe).apply(
          null,
          arguments
        )
      }),
    ...
    f._emscripten_sync_run_in_main_thread_xprintf_varargs = function () {
      return (f._emscripten_sync_run_in_main_thread_xprintf_varargs = f.asm.we).apply(
        null,
        arguments
      )
    }
    ...
    function Me(a) {
      ...
      if (!(0 < cb)) {
        if (!n) {
          if (f.preRun)
            for ('function' == typeof f.preRun && (f.preRun = [f.preRun]); f.preRun.length; ) bb()
          pb(Xa)
        }
        0 < cb ||
          (f.setStatus
